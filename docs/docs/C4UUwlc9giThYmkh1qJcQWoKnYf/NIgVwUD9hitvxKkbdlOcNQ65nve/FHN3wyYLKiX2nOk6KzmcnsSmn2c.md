...
还有另一种方法就是<b>利用3dmigoto本身的代码支持，实现透明</b>。这种方法更加通用，所以本文介绍这种方法。
...
可以看到有多个drawindex，如果代码内没有注释，我们可以通过在drawindex行前添加分号后回到游戏查看效果，来寻找裙子的drawindex，找到后，我们将这个drawindex<b>使用分号注释掉</b>，然后在上方添加一行代码：

<b>run = CustomShaderTransparency</b>
...
<b>这是最需要注意的一点。</b>如果我们回到ini代码中，会发现负责绘制裙子的drawindex，在负责绘制内裤的drawindex<b>之前，</b>这就是导致错误的原因：

<b>代码中的绘制顺序会影响最终mod的显示效果。</b>
...
一句话总结就是：<b>在ini代码中，需要按照由内到外的顺序进行绘制。</b>
